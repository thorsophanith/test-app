      ...
      <div class="shopping-cart">
        ...
        <div class="cart-table__wrapper">
              ...
              <tr>
                ...
                <td>
                  <div class="qty-control position-relative">
                    ...
                    <form method="POST" action="{{ route('cart.qty.dok',['rowId'=>$item->rowId]) }}">
                        @csrf
                        @method('PUT')
                    ...
                    <form method="POST" action="{{ route('cart.qty.bok',['rowId'=>$item->rowId]) }}">
                        @csrf
                        @method('PUT')
                ...
                <td>
                  ...
                  <form action="{{ route('cart.remove', ['rowId' => $item->rowId]) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
                    <a href="javascript:void(0)" class="remove-cart" onclick="event.preventDefault(); this.closest('form').submit();">
          ...
          <div class="cart-table-footer">
            ...
            @else
                <form action="{{ route('cart.remove.code') }}" method="POST" class="position-relative bg-body">
                  @csrf
                  @method('DELETE')
