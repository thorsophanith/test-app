                  ...
                  <ul class="list list-inline mb-0 brand-list">
                    ...
                    <li class="list-item">
                      <span class="menu-link py-1">
                        <input type="checkbox" name="brands" value="{{$brand->id}}" class="form-check-input"
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 p-4 order-1 order-md-0" aria-label="Page Size" name="pagesize" id="pagesize" style="margin-right:20px;">
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 p-4 order-1 order-md-0" aria-label="Sort Items" name="orderby" id="orderby">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{ route('shop.product.details', ['product_slug' => $products->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products')}}/{{$products->image}}" width="330" height="400" alt="{{ $products->name }}" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                        @foreach (explode(",",$products->images) as $gimg)
                      <a href="{{ route('shop.product.details', ['product_slug' => $products->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products')}}/{{$gimg}}" width="330" height="400" alt="{{ $products->name }}" class="pc__img"></a>
                        @endforeach
                    </div>
                  </div>
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">{{ $products->category->name }}</p>
                <h6 class="pc__title"><a href="{{ route('shop.product.details', ['product_slug' => $products->slug]) }}">Cropped Faux Leather Jacket</a></h6>
                ...
                <form action="{{ route('wishlist.remove',['rowId'=>Cart::instance('wishlist')->content()->where('id', $products->id)->first()->rowId]) }}" method="POST">
                @csrf
                @method('DELETE')
                <button type="submit" class="text-danger fw-bolder pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist filled-heart"
               ...
               <form method="POST" action="{{ route('wishlist.add') }}">
                ...
                <input type="hidden" name="id" value="{{ $products->id }}">
                <input type="hidden" name="name" value="{{ $products->name }}">
                <input type="hidden" name="price" value="{{ $products->sale_price == '' ? $prodects->regular_price : $products->sale_price }}">
                <input type="hidden" name="quantity" value="1"/>
        ...
        <div class="flex items-center justify-between flex-wrap gap10 wgp-pagiantion">
...
<form id="frmfilter" method="GET" action="{{ route('shop') }}" >
    ...
    <input type="hidden" name="categories" id="hdCategories">
