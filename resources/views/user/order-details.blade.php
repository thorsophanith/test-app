...
<main class="pt-90" style="padding-top: 0px;">
    ...
    <section class="my-account container">
        <h2 class="page-title">Ordered Details</h2>
        <div class="row">
            <div class="col-lg-2">
                @include('user.nav')
            </div>
                    ...
                    <div class="flex items-center justify-between gap10 flex-wrap">
                        <div class="row">
                           ...
                           <div class="col-6 text-right">
                            <a class="btn btn-sm btn-success" href="{{ route('admin.orders') }}">Back</a>
                           </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">N/A{{ $item->options }}</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($transaction->status == 'refunded')
                                           <span class="badge bg-seconday">Refunded</span>
                                    @else
